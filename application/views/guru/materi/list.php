                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <?php foreach ($mapel as $mpl) : ?>
                                                        <?php if ($mpl->id_mapel == $m->id_mapel) {
                                                            echo $mpl->nama_mapel;
                                                        } ?>
                                                    <?php endforeach; ?>
                                                </td>
                                                <td>
                                                    <?php foreach ($kelas as $kel) : ?>
                                                        <?php if ($kel->id_kelas == $m->id_kelas) {
                                                            echo $kel->nama_kelas;
                                                        } ?>
                                                    <?php endforeach; ?>
                                                </td>
        ...
        <form action="" method="POST" enctype="multipart/form-data">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <input type="hidden" name="kode_materi" value="<?= random_string('numeric', 3); ?>" class="form-control" required>
                    <div class="row">
                        <div class="col-lg-4">
                            ...
                            <div class="form-group">
                                ...
                                <select class="form-control" name="mapel" id="mapel_materi">
                                    ...
                                    <?php foreach ($mapel as $kel) : ?>
                                        <option value="<?= $kel->id_mapel; ?>"><?= $kel->nama_mapel; ?></option>
                                    <?php endforeach; ?>
                                </select>
                            </div>
                        </div>
    ...
    <div class="modal-dialog modal-lg" role="document">
        <form action="<?= base_url('guru/edit_materi'); ?>" method="POST" enctype="multipart/form-data">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <input type="hidden" name="e_id_materi" class="form-control" required>
                    <div class="row">
                        <div class="col-lg-4">
                            <div class="form-group">
                                <label for="">Nama Materi</label>
