                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <?php foreach ($mapel as $mpl) : ?>
                                                        <?php if ($mpl->id_mapel == $t->id_mapel) {
                                                            echo $mpl->nama_mapel;
                                                        } ?>
                                                    <?php endforeach; ?>
                                                </td>
                                                <td>
                                                    <?php foreach ($kelas as $kel) : ?>
                                                        <?php if ($kel->id_kelas == $t->id_kelas) {
                                                            echo $kel->nama_kelas;
                                                        } ?>
                                                    <?php endforeach; ?>
                                                </td>
        ...
        <form action="" method="POST" enctype="multipart/form-data">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <input type="hidden" name="kode_tugas" value="<?= random_string('numeric', 3); ?>" class="form-control" required>
                    <div class="row">
                        <div class="col-lg-4">
