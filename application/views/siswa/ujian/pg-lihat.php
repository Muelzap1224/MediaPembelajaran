...
<div id="content" class="main-content">
    <div class="layout-px-spacing">
        <input type="hidden" id="kode_ujian" value="<?= $ujian->id_ujian; ?>">
                                            ...
                                            <div class="card-body" style="position: relative;">
                                                ...
                                                <div style="margin-top: -20px;">
                                                    ...
                                                    foreach ($detail_ujian as $soal) : ?>
                                                        <?php $jawaban_siswa = $this->db->get_where('ujian_siswa', ['id_detail_ujian' => $soal->id_detail_ujian, 'id_siswa' => $this->session->userdata('id')])->row(); ?>
                                                        <p class="mt-3">
                                        ...
                                        <form action="<?= base_url('siswa/kirim_ujian'); ?>" method="POST">
                                            <div id="defaultAccordionOne" class="collapse" aria-labelledby="..." data-parent="#toggleAccordion">
                                                <div class="card-body" style="position: relative;">
                                                    ...
                                                    <input type="hidden" name="ujian" value="<?= $ujian->id_ujian; ?>">
                                                    <input type="hidden" name="siswa" value="<?= $this->session->userdata('id'); ?>">
                                                    <div style="margin-top: -20px;">
                                                        <?php
                                                        $no = 1;
