                    ...
                    <div class="widget-content">
                        <?php if ($tugas_siswa) : ?>
                            <?php foreach ($tugas_siswa as $ts) : ?>
                                <?php $tugas = $this->db->get_where('tugas', ['id_tugas' => $ts->id_tugas])->row(); ?>
                                <?php $mapel = $this->db->get_where('mapel', ['id_mapel' => $tugas->id_mapel])->row(); ?>
                    ...
                    <div class="widget-content">
                        <?php if ($materi_siswa) : ?>
                            <?php foreach ($materi_siswa as $ms) : ?>
                                <?php $materi = $this->db->get_where('materi', ['id_materi' => $ms->id_materi])->row(); ?>
                                <?php $mapel = $this->db->get_where('mapel', ['id_mapel' => $materi->id_mapel])->row(); ?>
                    ...
                    <div class="widget-content">
                        ...
                        <?php if ($ujian) : ?>
                            <?php foreach ($ujian as $u) : ?>
                                <?php $mapel = $this->db->get_where('mapel', ['id_mapel' => $u->id_mapel])->row(); ?>
                ...
                <div class="widget widget-five">
                    <div class="widget-content">
                        ...
                        <div class="w-content">
                            <div class="">
                                <p class="task-left">
                                    <?php $jumlah_tugas_siswa = $this->db->get_where('tugas_siswa', ['id_siswa' => $this->session->userdata('id')])->result(); ?>
                                    <?= count($jumlah_tugas_siswa); ?>
                                </p>
                                <?php $jumlah_tugas_siswa_selesai = $this->db->get_where('tugas_siswa', ['id_siswa' => $this->session->userdata('id'), 'is_telat' => 0])->result(); ?>
                                <p class="task-completed"><span><?= count($jumlah_tugas_siswa_selesai); ?> Tugas Sukses Dikerjakan</span></p>
                                <?php $jumlah_tugas_siswa_telat = $this->db->get_where('tugas_siswa', ['id_siswa' => $this->session->userdata('id'), 'is_telat' => 1])->result(); ?>
                        ...
                        <div class="w-content">
                            <div class="">
                                <p class="task-left">
                                    ...
                                    <?php $jumlah_materi_siswa = $this->db->get_where('materi', ['id_kelas' => $siswa->id_kelas])->result(); ?>
