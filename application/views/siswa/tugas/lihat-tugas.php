        ...
        <form action="<?= base_url('siswa/kumpulkan'); ?>" method="POST" enctype="multipart/form-data">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <input type="hidden" name="kode_tugas" value="<?= $tugas_siswa->id_tugas; ?>" class="form-control" required>
                    <input type="hidden" name="id_siswa" value="<?= $tugas_siswa->id_siswa; ?>" class="form-control" required>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <?php if ($tugas_siswa->file_siswa !== null) : ?>
                    <div class="row">
                        <?php $file_siswa = $this->db->get_where('tufile', ['id_tugas' => $tugas_siswa->file_siswa])->result(); ?>
