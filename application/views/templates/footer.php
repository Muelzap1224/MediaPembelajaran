...
<script src="<?= base_url('assets/app-assets/template/bahasa/'); ?>assets/js/libs/jquery-3.1.1.min.js"></script>
<script src="<?= base_url('assets/app-assets/template/bahasa/'); ?>bootstrap/js/popper.min.js"></script>
<script src="<?= base_url('assets/app-assets/template/bahasa/'); ?>bootstrap/js/bootstrap.min.js"></script>
<script src="<?= base_url('assets/app-assets/template/bahasa/'); ?>plugins/perfect-scrollbar/perfect-scrollbar.min.js"></script>
<script src="<?= base_url('assets/app-assets/template/bahasa/'); ?>assets/js/app.js"></script>
<script>
    $(document).ready(function() {
        App.init();
    });
</script>
<script src="<?= base_url('assets/app-assets/template/bahasa/'); ?>assets/js/custom.js"></script>
<!-- END GLOBAL MANDATORY SCRIPTS -->

<!-- BEGIN PAGE LEVEL PLUGINS/CUSTOM SCRIPTS -->
<script src="<?= base_url('assets/app-assets/template/bahasa/'); ?>plugins/apex/apexcharts.min.js"></script>
<script src="<?= base_url('assets/app-assets/template/bahasa/'); ?>assets/js/dashboard/dash_1.js"></script>
<script src="<?= base_url('assets/app-assets/template/bahasa/'); ?>plugins/table/datatable/datatables.js"></script>
<script src="<?= base_url('assets/app-assets/template/bahasa/'); ?>plugins/select2/select2.min.js"></script>
<script src="<?= base_url('assets/app-assets/template/bahasa/'); ?>plugins/select2/custom-select2.js"></script>
<script src="<?= base_url('assets/app-assets/template/bahasa/'); ?>plugins/file-upload/file-upload-with-preview.min.js"></script>
<script src="<?= base_url('assets/app-assets/template/bahasa/'); ?>assets/js/scrollspyNav.js"></script>
<script src="<?= base_url('assets/app-assets/template/bahasa/'); ?>plugins/jquery-step/jquery.steps.min.js"></script>
<script src="<?= base_url('assets/app-assets/template/bahasa/'); ?>plugins/jquery-step/custom-jquery.steps.js"></script>
